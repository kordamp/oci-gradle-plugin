...
trait OptionalContentEncodingAwareTrait implements PathAware, ProjectAware {
    private final StringState state = SimpleStringState.of(project, this, 'oci.content.encoding')
    ...
    @Input
    @Optional
    Provider<String> getResolvedContentEncoding() {
        state.provider
    }

    @Option(option = 'content-encoding', description = 'The content encoding of the Object (OPTIONAL).')
    void setContentEncoding(String contentEncoding) {
        getContentEncoding().set(contentEncoding)
    }
}
