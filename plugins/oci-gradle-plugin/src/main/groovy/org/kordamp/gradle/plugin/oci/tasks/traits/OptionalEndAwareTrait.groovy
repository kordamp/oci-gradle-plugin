...
trait OptionalEndAwareTrait implements PathAware, ProjectAware {
    private final StringState state = SimpleStringState.of(project, this, 'oci.end')
    ...
    @Input
    @Optional
    Provider<String> getResolvedEnd() {
        state.provider
    }

    @Option(option = 'end', description = 'The end parameter (OPTIONAL).')
