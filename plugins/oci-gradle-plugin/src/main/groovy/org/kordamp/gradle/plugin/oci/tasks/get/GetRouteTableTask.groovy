...
import org.kordamp.gradle.plugin.oci.tasks.traits.RouteTableIdAwareTrait
...
class GetRouteTableTask extends AbstractOCITask implements RouteTableIdAwareTrait {
    static final String TASK_DESCRIPTION = 'Displays information for a specific RouteTable.'
    ...
    protected void doExecuteTask() {
        ...
        RouteTable routeTable = client.getRouteTable(GetRouteTableRequest.builder()
            .rtId(getResolvedRouteTableId().get())
            .build())
            .routeTable
        ...
        if (routeTable) {
            ...
            println("RouteTable with id ${getResolvedRouteTableId().get()} was not found")
        }
    }
}
