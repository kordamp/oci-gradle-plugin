...
trait OptionalPrefixAwareTrait implements PathAware, ProjectAware {
    private final StringState state = SimpleStringState.of(project, this, 'oci.prefix')
    ...
    @Input
    @Optional
    Provider<String> getResolvedPrefix() {
        state.provider
    }

    @Option(option = 'prefix', description = 'The prefix parameter (OPTIONAL).')
    void setPrefix(String prefix) {
        getPrefix().set(prefix)
    }
}
