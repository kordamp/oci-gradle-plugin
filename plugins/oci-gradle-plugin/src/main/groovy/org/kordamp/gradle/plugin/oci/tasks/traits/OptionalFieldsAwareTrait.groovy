...
trait OptionalFieldsAwareTrait implements PathAware, ProjectAware {
    private final StringState state = SimpleStringState.of(project, this, 'oci.fields')
    ...
    @Input
    @Optional
    Provider<String> getResolvedFields() {
        state.provider
    }

    @Option(option = 'fields', description = 'The fields parameter (OPTIONAL).')
    void setFields(String fields) {
        getFields().set(fields)
    }
}
