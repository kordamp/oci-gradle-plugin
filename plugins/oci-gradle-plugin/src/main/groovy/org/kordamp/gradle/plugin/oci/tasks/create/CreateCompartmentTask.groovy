...
import org.kordamp.gradle.plugin.oci.tasks.traits.CompartmentDescriptionAwareTrait
import org.kordamp.gradle.plugin.oci.tasks.traits.CompartmentIdAwareTrait
import org.kordamp.gradle.plugin.oci.tasks.traits.CompartmentNameAwareTrait
...
class CreateCompartmentTask extends AbstractOCITask implements CompartmentIdAwareTrait,
    ...
    @Internal
    Property<String> getCreatedCompartmentId() {
        this.@createdCompartmentId
    }
